...
public enum ModArmorMaterials implements ArmorMaterial {
    PELT("pelt", 5, new int[]{1, 2, 3, 2}, 20, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.05F, () -> {
        return Ingredient.of(ModItems.ANIMAL_PELT.get());
    });
    ...
    public String getName() {
        return Insatiable.MOD_ID + ":" + this.name;
    }
